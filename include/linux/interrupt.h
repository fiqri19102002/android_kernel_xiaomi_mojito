 ...
 * IRQF_LITTLE_AFFINE - Interrupt is critical to the overall performance of
 *		      the system and should be processed on a little CPU.
 */
...
#define IRQF_LITTLE_AFFINE	0x00080000
